...
export function Header() {
  ...
  return (
    <header
      className={`min-w-0 w-full fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled || isMobileMenuOpen ? 'bg-background/80 backdrop-blur-md border-b border-white/5' : 'bg-transparent'}`}
    >
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 min-w-0 w-full">
